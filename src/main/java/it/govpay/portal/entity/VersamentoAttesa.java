...
@Entity
@Table(name = "vers_attesa")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class VersamentoAttesa {
    ...
    @OneToMany(mappedBy = "versamentoAttesa", cascade = CascadeType.ALL)
    @Builder.Default
    private List<SingoloVersamentoAttesa> singoliVersamenti = new ArrayList<>();
